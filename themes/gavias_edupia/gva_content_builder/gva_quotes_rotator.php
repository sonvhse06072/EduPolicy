...
if(!class_exists('element_gva_quotes_rotator')):
   class element_gva_quotes_rotator{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         ob_start();
         ?>
          <script type="text/javascript" src="<?php print (base_path() . \Drupal::service('extension.list.theme')->getPath('gavias_edupia')) ?>/vendor/quotes_rotator/js/modernizr.custom.js"></script>
         <script type="text/javascript" src="<?php print (base_path() . \Drupal::service('extension.list.theme')->getPath('gavias_edupia')) ?>/vendor/quotes_rotator/js/jquery.cbpQTRotator.min.js"></script>
