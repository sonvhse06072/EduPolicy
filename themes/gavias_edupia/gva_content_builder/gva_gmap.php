...
if(!class_exists('element_gva_gmap')):
   class element_gva_gmap{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         <script type="text/javascript" src="<?php print (base_path() . \Drupal::service('extension.list.theme')->getPath('gavias_edupia')) ?>/vendor/gmap3.js"></script>
         <script type="text/javascript" src="<?php print (base_path() . \Drupal::service('extension.list.theme')->getPath('gavias_edupia')) ?>/vendor/jquery.ui.map.min.js"></script>
