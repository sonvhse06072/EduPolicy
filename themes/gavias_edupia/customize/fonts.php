...
function gavias_edupia_render_option_font(){
    $fonts = gavias_edupia_fonts();
    $output = '';
...
function gavias_edupia_typography_font_styles($option, $selectors) {
    $output = $selectors . ' {';
...
function gavias_edupia_links_typography_font($json){
    ...
    if(isset($customize['font_family_primary']) && $customize['font_family_primary']){
        $links_fonts .= gavias_edupia_typography_enqueue_google_font($customize['font_family_primary']);
    }
    if(isset($customize['font_family_second']) && $customize['font_family_second']){
        $links_fonts .= gavias_edupia_typography_enqueue_google_font($customize['font_family_second']);
    }
    return $links_fonts;
}
